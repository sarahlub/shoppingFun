...
import 'schema/fashion_record.dart';
...
export 'schema/fashion_record.dart';
...
/// Functions to query FashionRecords (as a Stream and as a Future).
Future<int> queryFashionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FashionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FashionRecord>> queryFashionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FashionRecord.collection,
      FashionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FashionRecord>> queryFashionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
