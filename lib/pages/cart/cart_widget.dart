                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 0.0, 12.0),
                                  child: Text(
                                    '${FFAppState().cartNum.toString()}item(s)',
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return Column(
                                          ...
                                          children:
                                              List.generate(cartItems.length,
                                                  (cartItemsIndex) {
                                            final cartItemsItem =
                                            ...
                                            return Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 4.0, 0.0, 12.0),
                                              child:
                                                  StreamBuilder<FashionRecord>(
                                                stream:
                                                    FashionRecord.getDocument(
                                                        cartItemsItem),
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              CounterWidget(
                                                                key: Key(
                                                                    'Keyreu_${cartItemsIndex}_of_${cartItems.length}'),
                                                              ),
                                                            ],
                                                          ),
                                                        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '9or74r7i' /* Below is a list of your items. */,
                                ),
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                final paymentResponse =
                                  ...
                                  context,
                                  amount: functions
                                      .stripeTotal(FFAppState().cartSum)
                                      .round(),
                                  currency: 'EUR',
